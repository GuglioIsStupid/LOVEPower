...
/**
 * This struct is stored in a void pointer in the Box2D Body struct. For now, all
 ...
 **/
struct Body : public love::physics::Body
{
public:
	// Friends.
	friend struct Joint;
	friend struct DistanceJoint;
	friend struct MouseJoint;
	friend struct CircleShape;
	friend struct PolygonShape;
	friend struct Shape;
