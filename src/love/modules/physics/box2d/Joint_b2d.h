...
/**
 * This struct is stored in a void pointer in the Box2D Joint struct. For now, all
 ...
 **/
struct Joint : public love::physics::Joint
{
public:
	friend struct GearJoint;
...
protected:
	...
	/**
	 * Creates a Joint, and ensures that the parent struct
